import {BoundaryError, TenantContext, User, UserSummary, UserSummaryValidationError, UserValidationError} from "@domain"
...
export type UserListError = BoundaryError | UserListValidationError | UserSummaryValidationError | UnknownError
