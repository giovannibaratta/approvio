...
export class AgentFactory {
  ...
  // TODO: We have 3 similar functions. I assume they will only differ by the left type. We can define in a shared util and parametrize to avoid drift in the detection.
