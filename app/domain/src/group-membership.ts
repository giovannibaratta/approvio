...
function getEntityType(_entity: PrivateMembership["entity"]): EntityType {
...
export class GroupManager {
  ...
  private canAdministerGroup(requestor: User): boolean {
    ...
    if (requestor.orgRole === "admin") {
      return true
    }

    // Check if user has "manage" permission for this specific group
    const groupScope: GroupScope = {
      type: "group",
      groupId: this.group.id
    }
