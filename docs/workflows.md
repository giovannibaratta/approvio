...
sequenceDiagram
    ...
    System->>System: State: EVALUATION_IN_PROGRESS
    User->>System: Cast VETO
    System->>System: State: REJECTED
    User->>System: Cast WITHDRAW (retract VETO)
    System->>System: State: EVALUATION_IN_PROGRESS
```
